OC.L10N.register(
    ...
    "Please ask your administrator to check the OffiLibre server setting. The exact error message was: " : "Please ask your administrator to check the OffiLibre server setting. The exact error message was: ",
    "OffiLibre: The protocol specified in \"%s\" is not allowed." : "OffiLibre: The protocol specified in \"%s\" is not allowed.",
    "OffiLibre: Malformed URL \"%s\"." : "OffiLibre: Malformed URL \"%s\".",
    "OffiLibre: Cannot resolve the host \"%s\"." : "OffiLibre: Cannot resolve the host \"%s\".",
    "OffiLibre: Cannot connect to the host \"%s\"." : "OffiLibre: Cannot connect to the host \"%s\".",
    "OffiLibre: SSL certificate is not installed." : "OffiLibre: SSL certificate is not installed.",
    ...
    "OffiLibre unknown error: " : "OffiLibre unknown error: ",
    "OffiLibre: Unable to read discovery.xml from \"%s\"." : "OffiLibre: Unable to read discovery.xml from \"%s\".",
    "OffiLibre: discovery.xml from \"%s\" is not a well-formed XML string." : "OffiLibre: discovery.xml from \"%s\" is not a well-formed XML string.",
    "OffiLibre: Invalid URL \"%s\"." : "OffiLibre: Invalid URL \"%s\".",
    "Please ask your administrator to check the OffiLibre server setting." : "Please ask your administrator to check the OffiLibre server setting.",
    ...
    "Saved" : "Saved",
    "Saved with error: OffiLibre should use the same protocol as the server installation." : "Saved with error: OffiLibre should use the same protocol as the server installation.",
    "Saving..." : "Saving...",
    "None" : "None",
    "All" : "All",
    ...
    "guest" : "guest",
    "OffiLibre" : "OffiLibre",
    "OffiLibre server" : "OffiLibre server",
    "URL (and port) of the OffiLibre server that provides the editing functionality as a WOPI client." : "URL (and port) of the OffiLibre server that provides the editing functionality as a WOPI client.",
    "Apply" : "Apply",
    "Enable test server for specific groups" : "Enable test server for specific groups",
    "Groups" : "Groups",
    "Test server" : "Test server",
    "URL (and port) of the OffiLibre test server." : "URL (and port) of the OffiLibre test server.",
